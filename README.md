...
Next, we focus on obtaining 30-days predictions for the food insecurity time-series employing the eXtreme Gradient Boosting (XGBoost) machine learning algorithm. The effectiveness of our forecasting algorithm is tested on some administrative regions of Yemen and Syria over 2020. The results are promising and bode well for future implementation in WFP policy-making.
