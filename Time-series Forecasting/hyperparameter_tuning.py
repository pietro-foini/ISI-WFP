...
# Example usage: python hyperparameter_tuning.py --folder_path_to_dataset "./Nigeria/dataset" --folder_path_to_workspace "./Nigeria/out_hyper" --splits_to_consider 1 2 3 4 --fraction_train_set 0.8 --trial_steps 100 --gui_interface
