...
N.B. If `matplotlib = False`, the time-series are visualized using the plotly library which as you can see is much more engaging. Otherwise, the similar interactive plot is shown using matplotlib library.
...
Using the TsIP library, we now visualize the time-series using the matplotlib library:
